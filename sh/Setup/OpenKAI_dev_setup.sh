...
#----------------------------------------------------
# (Optional) PCL
git clone --branch pcl-1.11.0 --depth 1 https://github.com/PointCloudLibrary/pcl.git
cd pcl
mkdir build
cd build
