...
# Gstreamer
sudo apt-get -y install gstreamer1.0 gstreamer1.0-tools gstreamer1.0-plugins-good gstreamer1.0-plugins-ugly libgstreamer1.0-* libgstreamer-plugins-base1.0-dev

# Codecs
sudo apt-get -y install libdc1394-22 libdc1394-22-dev libjpeg-dev libpng-dev libtiff-dev libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libtheora-dev libxvidcore-dev x264 v4l-utils libvorbis-dev libmp3lame-dev libopencore-amrnb-dev libopencore-amrwb-dev
