...
// MESSAGE DEFINITIONS
#include "../uAvionix/mavlink_msg_uavionix_adsb_out_cfg.h"
#include "../uAvionix/mavlink_msg_uavionix_adsb_out_dynamic.h"
#include "../uAvionix/mavlink_msg_uavionix_adsb_transceiver_health_report.h"
