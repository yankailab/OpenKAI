...
#define MAVLINK_MSG_ID_SMART_BATTERY_INFO_LEN 75
#define MAVLINK_MSG_ID_SMART_BATTERY_INFO_MIN_LEN 75
#define MAVLINK_MSG_ID_370_LEN 75
#define MAVLINK_MSG_ID_370_MIN_LEN 75

#define MAVLINK_MSG_ID_SMART_BATTERY_INFO_CRC 124
#define MAVLINK_MSG_ID_370_CRC 124
...
#define MAVLINK_MESSAGE_INFO_SMART_BATTERY_INFO { \
    ...
    {  { "id", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_smart_battery_info_t, id) }, \
         { "battery_function", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_smart_battery_info_t, battery_function) }, \
         { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_smart_battery_info_t, type) }, \
         ...
         { "device_name", NULL, MAVLINK_TYPE_CHAR, 50, 25, offsetof(mavlink_smart_battery_info_t, device_name) }, \
...
static inline uint16_t mavlink_msg_smart_battery_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t id, uint8_t battery_function, uint8_t type, int32_t capacity_full_specification, int32_t capacity_full, uint16_t cycle_count, int32_t serial_number, const char *device_name, uint16_t weight, uint16_t discharge_minimum_voltage, uint16_t charging_minimum_voltage, uint16_t resting_minimum_voltage)
{
    ...
    _mav_put_uint8_t(buf, 23, battery_function);
    _mav_put_uint8_t(buf, 24, type);
    _mav_put_char_array(buf, 25, device_name, 50);
...
{
    return _MAV_RETURN_char_array(msg, device_name, 50,  25);
}
