...
namespace kai
{
	...
	bool _Orbbec::updateVzense(void)
	{
	...
	bool _Orbbec::setToFexposureControlMode(bool bAuto)
	{
	...
	bool _Orbbec::setToFexposureTime(bool bAuto, int tExposure)
	{
		m_vzCtrl.m_bAutoExposureToF = bAuto;
	...
	bool _Orbbec::setRGBexposureControlMode(bool bAuto)
	{
	...
	bool _Orbbec::setRGBexposureTime(bool bAuto, int tExposure)
	{
		m_vzCtrl.m_bAutoExposureRGB = bAuto;
	...
	bool _Orbbec::setTimeFilter(bool bON, int thr)
	{
	...
	bool _Orbbec::setConfidenceFilter(bool bON, int thr)
	{
	...
	bool _Orbbec::setFlyingPixelFilter(bool bON, int thr)
	{
	...
	bool _Orbbec::setFillHole(bool bON)
	{
	...
	bool _Orbbec::setSpatialFilter(bool bON)
	{
