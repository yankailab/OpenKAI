...
#ifndef SRC_SLAM_DSOOUTPUTWRAPPER_H_
#define SRC_SLAM_DSOOUTPUTWRAPPER_H_
...
{
public:
        inline DSOoutputWrapper()
        {
            printf("OUT: Created DSOoutputWrapper\n");
        }

        virtual ~DSOoutputWrapper()
        {
            printf("OUT: Destroyed DSOoutputWrapper\n");
        }
