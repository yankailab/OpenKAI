#ifndef OpenKAI_src_Primitive_vLongBit_H_
...
namespace kai
{
    ...
    public:
        ...
        vLongBit &operator^=(const vLongBit &v)
        {
            vector<uint64_t> out;
        ...
        friend vLongBit operator^(vLongBit a, const vLongBit &b)
        {
            a ^= b;
            return a;
        }
        ...
        bool operator==(const vLongBit &v) const
        {
            return m_vP == v.m_vP;
        }
        ...
        bool bSubsetOf(const vLongBit &v) const
        {
            size_t i = 0, j = 0;
        ...
        bool bIntersects(const vLongBit &v) const
        {
            size_t i = 0, j = 0;
        ...
        friend vLongBit operator<<(vLongBit a, uint64_t k)
        {
            a.shiftL(k);
            return a;
        }
