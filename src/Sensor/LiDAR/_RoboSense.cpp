 ...
 *      Author: yankai
 */
#include "_RoboSense.h"

namespace kai
{

    _RoboSense::_RoboSense()
    {
    ...
    int _RoboSense::init(void *pKiss)
    {
    ...
    // Common
    bool _RoboSense::recvLivoxCmd(_IObase *pIO, LIVOX2_CMD *pCmdRecv, bool bParity)
    {
        NULL_F(pIO);
        NULL_F(pCmdRecv);
    ...
    bool _RoboSense::recvLivoxData(_IObase *pIO, LIVOX2_DATA *pDataRecv, bool bParity)
    {
        NULL_F(pIO);
        NULL_F(pDataRecv);
    ...
    // Device Type Query
    void _RoboSense::updateWdeviceQuery(void)
    {
        while (m_pT->bAlive())
        {
            m_pT->autoFPS();
    ...
    void _RoboSense::sendDeviceQuery(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::updateRdeviceQuery(void)
    {
    ...
    void _RoboSense::handleDeviceQuery(const LIVOX2_CMD &cmd)
    {
    ...
    // Control Command
    void _RoboSense::updateWctrlCmd(void)
    {
    ...
    void _RoboSense::getLvxConfig(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxPCLdataType(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxPattern(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxHost(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxFrameRate(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxDetectMode(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxWorkModeAfterBoot(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxWorkMode(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::setLvxIMUdataEn(void)
    {
        IF_(check() != OK_OK);
    ...
    void _RoboSense::updateRctrlCmd(void)
    {
    ...
    void _RoboSense::handleCtrlCmdAck(const LIVOX2_CMD &cmd)
    {
    ...
    // Push command
    void _RoboSense::updateRpushCmd(void)
    {
    ...
    void _RoboSense::handlePushCmd(const LIVOX2_CMD &cmd)
    {
        IF_(cmd.cmd_id != 0x0000);
    }

    // Point Cloud Data
    void _RoboSense::updateRpointCloud(void)
    {
    ...
    void _RoboSense::handlePointCloudData(const LIVOX2_DATA &d)
    {
    ...
    // IMU
    void _RoboSense::updateRimu(void)
    {
    ...
    void _RoboSense::handleIMUdata(const LIVOX2_DATA &d)
    {
...
//        uint64_t tStamp = *((uint64_t *)d.timestamp);
    ...
    LVX2_CONFIG _RoboSense::getConfig(void)
    {
        return m_lvxCfg;
    }

    void _RoboSense::setConfig(const LVX2_CONFIG &cfg)
    {
        m_lvxCfg = cfg;
    }

    void _RoboSense::console(void *pConsole)
    {
        NULL_(pConsole);
