...
int CamMarkerDetect::getObjLockLevel(void)
{
	return 	m_objLockLevel;
}

bool CamMarkerDetect::getObjPosition(fVector3* pPos)
{
...
bool CamMarkerDetect::getObjAttitude(fVector3* pAtt)
{
...
void CamMarkerDetect::setObjROI(fVector3 ROI)
{
	m_objROIPos = ROI;
}
