...
#else
#define LOG_(x) {string s = x; printf("%s\n",s.c_str());}
...
#define IF_d_T(x,y) if(x){y;return true;}
#define IF_d_F(x,y) if(x){y;return false;}
#define IF_d_N(x,y) if(x){y;return NULL;}
#define IF_d_(x,y) if(x){y;return;}
#define IF_d__(x,y,z) if(x){y;return z;}
...
#define NULL_d_(x,y) if(x==NULL){y;return;}
#define NULL_d__(x,y,z) if(x==NULL){y;return z;}
#define NULL_d_F(x,y) if(x==NULL){y;return false;}
#define NULL_d_N(x,y) if(x==NULL){y;return NULL;}
#define NULL_d_T(x,y) if(x==NULL){y;return true;}
