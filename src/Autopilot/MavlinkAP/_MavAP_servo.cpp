#include "_MavAP_servo.h"

namespace kai
{

	_MavAP_servo::_MavAP_servo()
	{
		m_pAP = nullptr;
	}
	...
	int _MavAP_servo::init(void *pKiss)
	{
	...
	int _MavAP_servo::start(void)
	{
		NULL__(m_pT, OK_ERR_NULLPTR);
		return m_pT->start(getUpdate, this);
	}

	int _MavAP_servo::check(void)
	{
	...
	void _MavAP_servo::updateServo(void)
	{
		IF_(check() != OK_OK);
	...
	void _MavAP_servo::console(void *pConsole)
	{
		NULL_(pConsole);
