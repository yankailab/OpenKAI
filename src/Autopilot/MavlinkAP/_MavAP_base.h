#ifndef OpenKAI_src_Autopilot_MavAP__MavAP_base_H_
#define OpenKAI_src_Autopilot_MavAP__MavAP_base_H_
...
namespace kai
{
	...
	class _MavAP_base : public _ModuleBase
	{
	public:
		_MavAP_base();
		~_MavAP_base();
