#ifndef OpenKAI_src_Autopilot_MavAP__MavAP_visionEstimate_H_
#define OpenKAI_src_Autopilot_MavAP__MavAP_visionEstimate_H_
...
namespace kai
{
	...
	class _MavAP_visionEstimate : public _ModuleBase
	{
	public:
		_MavAP_visionEstimate();
		~_MavAP_visionEstimate();
	...
	protected:
		...
		{
			((_MavAP_visionEstimate *)This)->update();
			return NULL;
		}
