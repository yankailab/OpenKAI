#ifndef OpenKAI_src_Autopilot_MavAP__MavAP_land_H_
#define OpenKAI_src_Autopilot_MavAP__MavAP_land_H_
...
namespace kai
{
	...
	class _MavAP_land : public _MavAP_follow
	{
	public:
		_MavAP_land();
		~_MavAP_land();
