#include "_MavAP_GPS.h"

namespace kai
{

	_MavAP_GPS::_MavAP_GPS()
	{
		m_pAP = nullptr;
		m_pSB = nullptr;
	...
	int _MavAP_GPS::init(void *pKiss)
	{
	...
	int _MavAP_GPS::start(void)
	{
		NULL__(m_pT, OK_ERR_NULLPTR);
		return m_pT->start(getUpdate, this);
	}

	int _MavAP_GPS::check(void)
	{
	...
	void _MavAP_GPS::updateGPS(void)
	{
		IF_(check() != OK_OK);
	...
	void _MavAP_GPS::console(void *pConsole)
	{
		NULL_(pConsole);
