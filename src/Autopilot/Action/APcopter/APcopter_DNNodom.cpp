#include "../APcopter/APcopter_DNNodom.h"
...
bool APcopter_DNNodom::init(void* pKiss)
{
...
bool APcopter_DNNodom::link(void)
{
...
void APcopter_DNNodom::update(void)
{
...
void APcopter_DNNodom::updateZEDtracking(void)
{
	NULL_(m_pZED);
	IF_(!m_pZED->isOpened());
...
//    ry += m_mR.y;
//    rz += m_mR.z;
//    printf("DNNodom:  f=%.5lf\t r=%.5lf\t d=%.5lf\t | r=%.5lf\t p=%.5lf\t y=%.5lf\n",tx,ty,tz,rx,ry,rz);

}

bool APcopter_DNNodom::draw(void)
{
