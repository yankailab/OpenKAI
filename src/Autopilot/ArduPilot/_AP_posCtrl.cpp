...
namespace kai
{
	...
	void _AP_posCtrl::console(void *pConsole)
	{
		...
		pC->addMsg("Local NED:");
		pC->addMsg("vTargetP = (" + f2str(m_vTargetP.x) + ", " + f2str(m_vTargetP.y) + ", " + f2str(m_vTargetP.z) + ", " + f2str(m_vTargetP.w) + ")", 1);
		pC->addMsg("vP = (" + f2str(m_vP.x) + ", " + f2str(m_vP.y) + ", " + f2str(m_vP.z) + ", " + f2str(m_vP.w) + ")", 1);
		...
		pC->addMsg("vTargetGlobal = (" + lf2str(m_vTargetGlobal.x, 7) + ", " + lf2str(m_vTargetGlobal.y, 7) + ", " + lf2str(m_vTargetGlobal.z, 2) + ", " + lf2str(m_vTargetGlobal.w, 2) + ")", 1);
	}
